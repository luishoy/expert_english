  ...
  Future<void> _getListQuestion() async {
    ...
    try {
      final Response response = await Dio().post(
        'http://192.168.0.100//cur/Api_functions/lista_preguntas_game',
                ...
                Column(
                  children: [
                    ...
                    if (file_preg.contains('.png') ||
                      ...
                      Image.network(
                        'http://192.168.0.100/cur/uploads/files_game/$file_preg',
                        height: 200,
                        width: 200,
                      ),
...
Future<List<dynamic>> _getListAlternatives(
  ...
  try {
    final Response response = await Dio().post(
      'http://192.168.0.100/cur/Api_functions/lista_alternativas',
